...
for method in ds.get.get_all_methods('numpy') 
    print(method)
    try:
        methods = ds.get.get_object_signature(method) 
    except:
        methods = ['Exception in get_object_signature!!!!!!!!!!'] 
    print('    ', methods)
